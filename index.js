...
// Create WebSocket server attached to the HTTP server with a custom path
...
// Start the server
server.listen(9098, () => {
    console.log('HTTP server started on port 9098');
    console.log('WebSocket server available at ws://localhost:9098/ws');
});
